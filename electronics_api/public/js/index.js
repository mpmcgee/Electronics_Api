var oldHash = '';
var baseUrl_API = "http://localhost:8080/electronics_api/electronics_api/api"; // you need to fill this variable with your own api url
...
function home() {
    ...
    updateMain('Home', 'Welcome to Electronics Application', _html);
}
